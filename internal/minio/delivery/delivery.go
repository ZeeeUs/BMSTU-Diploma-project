...
//	router.HandleFunc(fileURL, h.GetFile)
//	router.HandleFunc(filesURL, h.GetFilesByNoteUUID)
//	router.HandleFunc(filesURL, h.CreateFile)
//	router.HandleFunc(filesURL, h.DeleteFile)
//
